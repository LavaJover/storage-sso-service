...
var file_sso_proto_rawDesc = string([]byte{
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x6f, 0x0a, 0x0c, 0x41, 0x75, 0x74, 0x68, 0x52,
	...
	0x6e, 0x32, 0xf6, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x19, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x56, 0x61, 0x6c,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x41, 0x75,
	0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x46, 0x5a, 0x44, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4c, 0x61, 0x76, 0x61, 0x4a, 0x6f, 0x76,
	0x65, 0x72, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2d, 0x73, 0x73, 0x6f, 0x2d, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x73, 0x73, 0x6f, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x65, 0x6e, 0x3b, 0x73, 0x73, 0x6f,
...
var file_sso_proto_goTypes = []any{
	...
	(*ValidateTokenResponse)(nil), // 4: sso.ValidateTokenResponse
...
var file_sso_proto_depIdxs = []int32{
	...
	1, // 1: sso.AuthService.Login:input_type -> sso.LoginRequest
	3, // 2: sso.AuthService.ValidateToken:input_type -> sso.ValidateTokenRequest
	5, // 3: sso.AuthService.RefreshToken:input_type -> sso.RefreshTokenRequest
	2, // 4: sso.AuthService.Register:output_type -> sso.AuthResponse
	2, // 5: sso.AuthService.Login:output_type -> sso.AuthResponse
	4, // 6: sso.AuthService.ValidateToken:output_type -> sso.ValidateTokenResponse
	2, // 7: sso.AuthService.RefreshToken:output_type -> sso.AuthResponse
